...
(
    ...
    function (a)
    { 
        var b, c = {}, d = !!document.querySelector && !!a.addEventListener, 
        e = { initClass: "js-inlinesvg", svgSelector: "img.svg" }, 
        f = function (a, b) 
        { 
            return function () { if (--a < 1) return b.apply(this, arguments) 
            ...
            { 
                ...
                { 
                    ...
                    if (h.removeAttribute("xmlns:a"), 
                        ...
                        h.classList ? h.classList.add("inlined-svg") : h.setAttribute("class", 
                        h.getAttribute("class") + " inlined-svg"), 
                        h.setAttribute("role", "img"), 
                        f.alt) 
                    { 
                        var j = document.createElementNS("http://www.w3.org/2000/svg", "title"), k = document.createTextNode(f.alt.value);
                        if (j.setAttribute("id", i()), 
                            j.appendChild(k), 
                            h.insertBefore(j, h.firstChild), 
                            f.id) 
                            h.setAttribute("aria-labelledby", f.id.value); 
                        else if (!f.id) 
                        { 
                            var l = function () 
                            { 
                    ...
                    { 
                        ...
                        { 
                            ...
                            h.setAttribute("aria-labelledby", o()) 
                    } 
    ...
    { 
        d && (b = g(e, a || {}), j(c || function () { }), 
        document.documentElement.className += " " + b.initClass) 
    }, c 
});